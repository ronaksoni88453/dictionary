...
but = Button(root, padx=2, pady=2, text='Search', command=clk, bg='powder blue', font=('none 15 bold'))
...
ent=Entry(root,width=23,font=('none 12 bold'),textvar=textin,bg='white')
ent.place(x=200 ,y=100,)

but=Button(root,padx=2,pady=2,text='Search',command=clk,bg='powder blue',font=('none 15 bold'))
but.place(x=225,y=150)

but4=Button(root,padx=2,pady=2,text='Clear',font=('none 15 bold'),bg='powder blue',command=clr)
but4.place(x=275,y=420)

output=Text(root,width=21,height=10,font=('Time 15 bold'),fg="black")
output.place(x=200,y=200)
